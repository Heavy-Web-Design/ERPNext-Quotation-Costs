...
def add_custom_fields():
    ...
    custom_fields = {
        "Quotation": [
            ...
            dict(fieldname='total_average_profit_percent', label='Total Average Profit Percent', fieldtype='Float', insert_after='column_break_qc3'),
            dict(fieldname='column_break_qc4', label='', fieldtype='Column Break', insert_after='total_average_profit_percent'),
            dict(fieldname='total_profit_amount', label='Total Profit Amount', fieldtype='Currency', insert_after='column_break_qc4'),
